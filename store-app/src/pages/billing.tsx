    ...
    <div className="flex flex-col md:flex-row h-[calc(100dvh-3.5rem-2rem)] md:h-[calc(100dvh-2*1.5rem)] gap-4 md:gap-5">
      ...
      <div className="flex flex-1 flex-col gap-3 min-h-0">
        <div className="flex items-center gap-2">
          ...
          {cartCount > 0 && (
            <Badge className="bg-primary text-primary-foreground px-2.5 py-1 text-sm font-bold">
              {cartCount}
            </Badge>
          )}
        </div>
                  ...
                  <Card
                    ...
                    className={cn(
                      ...
                      outOfStock
                        ...
                        : "hover:border-primary hover:shadow-sm active:scale-[0.97]",
      ...
      <Card
        className={cn(
          "flex flex-col w-full md:w-80 lg:w-96 shrink-0 transition-all",
          billSuccess && "border-green-400"
        )}
      >
        ...
        <CardFooter className="flex-col border-t bg-muted/30 px-4 py-4 gap-3">
          ...
          <Select
            value={paymentMode}
            onValueChange={(val) => {
              setPaymentMode(val as BillInputPaymentMode);
              if (val !== "khata") setSelectedCustomerId("");
            }}
          >
