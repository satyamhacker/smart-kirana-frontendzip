...
import { Store, Printer, FileText, MessageCircle, User, Save } from "lucide-react";
    ...
    <div className="space-y-6 max-w-2xl" data-testid="page-settings">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Apni dukaan ki details yahan set karein
        </p>
      </div>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <Input
              ...
              placeholder="e.g. Gandhi Nagar, Ward No. 5, District"
            />
          </div>
          <div className="space-y-1.5">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            WhatsApp pe bill ya reminder bhejne ke liye
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="space-y-1.5">
