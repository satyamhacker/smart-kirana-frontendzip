          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="col-span-2">
                ...
                <FormControl>
                  <Input {...field} placeholder="e.g. Tata Salt 1kg" data-testid="input-product-name" />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input {...field} placeholder="e.g. Grocery" data-testid="input-category" />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input {...field} placeholder="e.g. 890123..." data-testid="input-barcode" />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input type="number" {...field} data-testid="input-low-stock-threshold" />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
...
export default function Products() {
  ...
  const handleEdit = (values: ProductFormValues) => {
    ...
    updateProduct.mutate(
      ...
      {
        onSuccess: () => {
          toast({ title: "Product update hua" });
          invalidate();
  ...
  const handleDelete = (id: number, name: string) => {
    ...
    deleteProduct.mutate(
      ...
      {
        onSuccess: () => {
          toast({ title: "Product delete hua" });
          invalidate();
        },
  ...
  const getStockBadge = (product: Product) => {
    if (product.currentStock === 0) {
      return (
        <Badge className="bg-red-100 text-red-700 border border-red-200 font-normal">
          Out of Stock
        </Badge>
      );
    }
    if (product.currentStock <= product.lowStockThreshold) {
      return (
        <Badge className="bg-amber-100 text-amber-700 border border-amber-200 font-normal">
          Low Stock
        </Badge>
      );
    }
      ...
      <div className="flex flex-wrap justify-between items-center gap-3">
        <div>
          ...
          <p className="text-xs text-muted-foreground mt-0.5">
            {products.length} products · Inventory manage karein
          </p>
        </div>
